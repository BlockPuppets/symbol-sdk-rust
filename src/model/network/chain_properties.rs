...
pub struct ChainProperties {
    ...
    #[serde(rename = "enableVerifiableState", skip_serializing_if = "Option::is_none")]
    ...
    #[serde(rename = "enableVerifiableReceipts", skip_serializing_if = "Option::is_none")]
    ...
    #[serde(rename = "blockGenerationTargetTime", skip_serializing_if = "Option::is_none")]
    pub block_generation_target_time: Option<String>,
    /// A higher value makes the network more biased.
    #[serde(rename = "blockTimeSmoothingFactor", skip_serializing_if = "Option::is_none")]
    pub block_time_smoothing_factor: Option<String>,
    /// Number of blocks between successive finalization attempts.
    #[serde(rename = "blockFinalizationInterval", skip_serializing_if = "Option::is_none")]
    ...
    #[serde(rename = "importanceActivityPercentage", skip_serializing_if = "Option::is_none")]
    ...
    #[serde(rename = "maxDifficultyBlocks", skip_serializing_if = "Option::is_none")]
    pub max_difficulty_blocks: Option<String>,
    /// Default multiplier to use for dynamic fees.
    #[serde(rename = "defaultDynamicFeeMultiplier", skip_serializing_if = "Option::is_none")]
    pub default_dynamic_fee_multiplier: Option<String>,
    /// Maximum lifetime a transaction can have before it expires.
    #[serde(rename = "maxTransactionLifetime", skip_serializing_if = "Option::is_none")]
    ...
    #[serde(rename = "initialCurrencyAtomicUnits", skip_serializing_if = "Option::is_none")]
    ...
    #[serde(rename = "maxMosaicAtomicUnits", skip_serializing_if = "Option::is_none")]
    pub max_mosaic_atomic_units: Option<String>,
    /// Total whole importance units available in the network.
    #[serde(rename = "totalChainImportance", skip_serializing_if = "Option::is_none")]
    ...
    #[serde(rename = "minHarvesterBalance", skip_serializing_if = "Option::is_none")]
    ...
    #[serde(rename = "maxHarvesterBalance", skip_serializing_if = "Option::is_none")]
    ...
    #[serde(rename = "maxVotingKeysPerAccount", skip_serializing_if = "Option::is_none")]
